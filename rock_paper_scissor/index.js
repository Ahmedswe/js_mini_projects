...
function play_round(human_choice){
    ...
    if (!game_over) {
        ...
        if (result) {
            human_score ++;
            document.getElementById("round_winner").textContent = "player won this round "
        }else if(result == null){
            document.getElementById("round_winner").textContent = "draw"    
        }else{
            computer_score++;
            document.getElementById("round_winner").textContent = "computer won this round "
        }
        document.getElementById("result").textContent = `Player score: ${human_score} Computer score: ${computer_score}`;
...
function replay(){
    ...
    document.getElementById("round_winner").textContent = "";
